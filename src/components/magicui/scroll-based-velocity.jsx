...
function ParallaxText({ children, baseVelocity = 100, ...props }) {
  ...
  return (
    <div ref={containerRef} className="w-full overflow-hidden whitespace-nowrap mb-4" {...props}>
...
export function VelocityScroll({ defaultVelocity = 5, numRows = 2, children, className, ...props }) {
  return (
    <div
      className={cn(
        "relative w-full text-4xl font-bold tracking-[-0.02em] md:text-7xl transition-all duration-300 space-y-2",
        className,
      )}
      {...props}
    >
